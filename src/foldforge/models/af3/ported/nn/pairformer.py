...
from foldforge.models.af3.ported import fastnn
from foldforge.models.af3.ported.nn.attention import GridSelfAttention, MSAAttention
from foldforge.models.af3.ported.nn.diffusion_transformer import SelfAttention
from foldforge.models.af3.ported.nn.primitives import OuterProductMean, Transition
from foldforge.models.af3.ported.nn.triangle_multiplication import (
    ...
    def forward(
        ...
        def update_msa(value, updated_pair):
            return msa_row_update(
                ...
                transition_residual=lambda m: transition_residual(self.msa_transition, m),
            )
        def update_pair(value):
            value = triangle_residual(self.triangle_multiplication_outgoing, value, pair_mask)
            value = triangle_residual(self.triangle_multiplication_incoming, value, pair_mask)
        ...
        return msa_pair_update(
            msa, pair, config=self.msa_update_config,
            outer_product_delta=lambda m: self.outer_product_mean(m, msa_mask),
            msa_residual=update_msa, pair_residual=update_pair,
        )
