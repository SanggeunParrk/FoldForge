...
from foldforge.models.af3.ported.nn import atom_layout
        ...
        for super_block_i in range(self.num_super_blocks):
            ...
            for j in range(self.super_block_size):
                ...
                act = conditioned_residual(
                    act, single_cond,
                    attention=lambda value: self.self_attention[idx](
...
class CrossAttention(nn.Module):
    ...
    def forward(
        ...
        logits = torch.einsum('...qhc,...khc->...hqk',
                              q.float() * self.q_scale, k.float()) + bias
    ...
    def forward(
        ...
        for block_idx in range(self.num_blocks):
            ...
            queries_act = conditioned_residual(
                ...
                attention=lambda value: self.cross_attention[block_idx](
                    x_q=value, x_k=keys_act,
                    mask_q=queries_mask, mask_k=keys_mask,
