...
from foldforge.models.opendde.ported.distributed.foldcp.atom_window import FoldCPWindowShardSpec
from foldforge.models.opendde.ported.distributed.foldcp.comm import run_group_rank_action_synchronized
...
from foldforge.models.opendde.ported.distributed.foldcp.msa_pair_weighted import collect_msa_pair_row_slab
...
from foldforge.models.opendde.ported.model.modules.primitives import LinearNoBias, Transition
from foldforge.models.opendde.ported.model.modules.transformer import (
...
from foldforge.models.opendde.ported.model.utils import expand_at_dim, get_checkpoint_fn, permute_final_dims
...
class DiffusionConditioning(nn.Module):
    ...
    def _apply_pair_z_transitions(
        ...
        if torch.is_grad_enabled():
            if inplace_safe:
                pair_z = transition_residual(self.transition_z1, pair_z)
                pair_z = transition_residual(self.transition_z2, pair_z)
                return pair_z
            pair_z = transition_residual(self.transition_z1, pair_z)
    ...
    def forward(
        ...
        if inplace_safe:
            single_s = transition_residual(self.transition_s1, single_s)
            single_s = transition_residual(self.transition_s2, single_s)
        else:
            single_s = transition_residual(self.transition_s1, single_s)
            single_s = transition_residual(self.transition_s2, single_s)
