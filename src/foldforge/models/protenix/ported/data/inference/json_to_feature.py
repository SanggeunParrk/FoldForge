...
from foldforge.models.protenix.ported.data.core.geometry_featurizer import GeometryFeaturizer
from foldforge.models.protenix.ported.data.core.parser import AddAtomArrayAnnot
from foldforge.models.protenix.ported.data.inference.json_parser import (
    add_entity_atom_array,
    remove_leaving_atoms,
)
from foldforge.models.protenix.ported.data.tokenizer import AtomArrayTokenizer, TokenArray
from foldforge.models.protenix.ported.data.utils import int_to_letters
...
class SampleDictToFeatures:
    ...
    def get_entity_poly_type_and_seqs(self) -> dict[dict[str, str], dict[str, str]]:
        """
