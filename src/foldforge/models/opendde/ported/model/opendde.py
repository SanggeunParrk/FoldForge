...
from foldforge.models.opendde.ported.config.schema import OpenDDEConfig
from foldforge.models.opendde.ported.data.tokenizer import STRUCTURAL_TOKEN_ROLES
...
from foldforge.models.opendde.ported.distributed.foldcp.metrics import (
    FoldCPBenchmarkRecorder,
    measure_foldcp_stage,
)
from foldforge.models.opendde.ported.distributed.foldcp.pair_sharding import shard_pair_tensor
...
from foldforge.models.opendde.ported.distributed.foldcp.trunk_init import (
    apply_trunk_z_cycle_local,
    build_trunk_z_init_local,
)
from foldforge.models.opendde.ported.model import sample_confidence
from foldforge.models.opendde.ported.model.generator import (
    InferenceNoiseScheduler,
    sample_diffusion,
)
from foldforge.models.opendde.ported.model.modules.confidence import ConfidenceHead
from foldforge.models.opendde.ported.model.modules.diffusion import DiffusionModule
from foldforge.models.opendde.ported.model.modules.embedders import (
    InputFeatureEmbedder,
    RelativePositionEncoding,
)
from foldforge.models.opendde.ported.model.modules.head import DistogramHead
from foldforge.models.opendde.ported.model.modules.pairformer import (
    MSAModule,
    PairformerStack,
    TemplateEmbedder,
)
from foldforge.models.opendde.ported.model.modules.primitives import LinearNoBias
from foldforge.models.opendde.ported.model.shape_complementarity import (
    build_shape_comp_pred_outputs,
    compute_shape_complementarity_fields,
    get_shape_comp_atom_mask,
)
from foldforge.models.opendde.ported.model.modules.structural_tokens import StructuralTokenExpander
from foldforge.models.opendde.ported.model.triangular.layers import LayerNorm
from foldforge.models.opendde.ported.model.utils import simple_merge_dict_list
from foldforge.models.opendde.ported.utils.logger import get_logger
from foldforge.models.opendde.ported.utils.torch_utils import autocasting_disable_decorator
...
def update_input_feature_dict(input_feature_dict: dict[str, Any]) -> dict[str, Any]:
    ...
    Returns:
            input_feature_dict (dict[str, Any]): input features
    """
    from foldforge.models.opendde.ported.model.modules.transformer import rearrange_qk_to_dense_trunk
