...
if _use_fast_layer_norm:
    try:
        from foldforge.models.opendde.ported.model.layer_norm.layer_norm import FusedLayerNorm
...
def skip_random_init():
    ...
    * reset_parameters in torch.nn.Linear which includes kaiminig_uniform_
    ...
    from foldforge.models.opendde.ported.model.modules import primitives
