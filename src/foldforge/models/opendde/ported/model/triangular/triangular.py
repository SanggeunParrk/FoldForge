...
from foldforge.modules.af_family import enabled, triangle_residual

import torch
import torch.nn as nn

from foldforge.models.opendde.ported.model.triangular.layers import Attention, LayerNorm, OpenfoldLinear
from foldforge.models.opendde.ported.model.utils import chunk_layer, is_fp16_enabled, permute_final_dims
...
class TriangleMultiplicativeUpdate(BaseTriangleMultiplicativeUpdate):
    ...
    def forward(
        ...
        Returns:
            [*, N_res, N_res, C_z] output tensor
        """
        if _add_with_inplace and not self.training and enabled(self, z):
            return triangle_residual(self, z, mask)
