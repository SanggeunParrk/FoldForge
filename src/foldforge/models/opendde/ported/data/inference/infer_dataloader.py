...
from foldforge.models.opendde.ported.data.core import ccd
from foldforge.models.opendde.ported.data.inference.input_validation import validate_inference_jobs
from foldforge.models.opendde.ported.data.inference.json_to_feature import SampleDictToFeatures
from foldforge.models.opendde.ported.data.msa.msa_featurizer import InferenceMSAFeaturizer
from foldforge.models.opendde.ported.data.template.template_featurizer import InferenceTemplateFeaturizer
from foldforge.models.opendde.ported.data.template.template_utils import TemplateHitFeaturizer
from foldforge.models.opendde.ported.data.utils import data_type_transform, make_dummy_feature
from foldforge.models.opendde.ported.utils.distributed import DIST_WRAPPER
from foldforge.models.opendde.ported.utils.torch_utils import collate_fn_identity, dict_to_tensor
...
class InferenceDataset(Dataset):
    def __init__(
        ...
        self.use_rna_msa = self.use_rna_msa or any(
            ...
            for target in self.inputs for chain in target["sequences"]
        )
