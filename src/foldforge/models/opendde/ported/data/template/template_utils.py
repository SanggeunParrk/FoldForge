...
from foldforge.models.opendde.ported.data.template.template_parser import (
    AlignRatioError,
    CaDistanceError,
    DateError,
    DuplicateError,
...
from foldforge.models.opendde.ported.data.tools.kalign import Kalign
...
from foldforge.models.opendde.ported.utils.file_io import compat_pickle_load

_POLYMER_FEATURES: Final[Mapping[str, DTypeLike]] = {
    ...
    def _check_residue_distances(
        ...
        if max_found > max_dist:
            ...
            raise CaDistanceError(
                f"Distance between residues {idx_a} and {idx_b} is {max_found:.2f} > {max_dist}"
            )
