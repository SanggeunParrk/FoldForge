...
from foldforge.models.opendde.ported.data.msa.msa_utils import map_to_standard
from foldforge.models.opendde.ported.data.template.template_parser import HHRParser, HmmsearchA3MParser
from foldforge.models.opendde.ported.data.template.template_utils import (
    TEMPLATE_FEATURES,
    DistogramFeaturesConfig,
    TemplateFeatures,
    TemplateHitFeaturizer,
)
from foldforge.models.opendde.ported.data.utils import pad_to
    ...
    def make_template_feature(
        ...
        for eid, info in enumerate(bioassembly):
            ...
            if use_template and "proteinChain" in info and "miniworldTemplates" in info["proteinChain"]:
                ...
                templates = template_features(info["proteinChain"]["miniworldTemplates"], seq, "opendde")
