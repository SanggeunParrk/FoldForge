...
from foldforge.models.opendde.ported.model.utils import one_hot
from foldforge.models.opendde.ported.utils.torch_utils import cdist, disabled_autocast
...
def _transpose_pair_tile_collective(
    ...
    *,
    ...
    if mesh.layout.shape[0] == 1 and mesh.layout.shape[1] > 1:
        from foldforge.models.opendde.ported.distributed.foldcp.distogram import (
