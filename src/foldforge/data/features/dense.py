...
class MSA:
    ...
    def index_msa_rows(self, indices: torch.Tensor) -> Self:
        ...
        if indices.ndim != 1:
            message = "Invalid state: indices.ndim == 1"
...
class AtomCrossAtt:
    ...
    def as_data_dict(self) -> BatchDict:
        """Convert to data dict."""
        return {
            **self.token_atoms_to_queries.as_dict(key_prefix="token_atoms_to_queries"),
            ...
            **self.queries_to_token_atoms.as_dict(key_prefix="queries_to_token_atoms"),
        }
...
class ConvertModelOutput:
    ...
    @classmethod
    def from_data_dict(cls, batch: BatchDict) -> Self:  # noqa: ARG003 - shared callback or fixture signature
    ...
    def as_data_dict(self) -> BatchDict:
        """Return an empty mapping: output structures stay outside Tensor batches."""
        return {}
