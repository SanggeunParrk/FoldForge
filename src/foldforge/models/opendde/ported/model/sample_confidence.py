...
from foldforge.models.opendde.ported.config.schema import BinConfig, OpenDDEConfig
from foldforge.models.opendde.ported.metrics.clash import Clash
from foldforge.models.opendde.ported.model.utils import distogram_bin_tops
from foldforge.models.opendde.ported.utils.distributed import traverse_and_aggregate
...
def _compute_full_data_and_summary(
    ...
    summary_confidence.update(
        calculate_chain_based_plddt(atom_plddt, token_asym_id, atom_to_token_idx)
    )
    del pae_prob
...
def get_bin_params(cfg: BinConfig) -> dict:
    """
...
def calculate_ptm(
    ...
    Args:
        pae_prob (torch.Tensor): Predicted probability from the PAE head.
            Shape: [..., N_token, N_token, N_bins]
