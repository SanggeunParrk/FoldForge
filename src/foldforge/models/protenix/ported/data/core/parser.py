...
from foldforge.models.protenix.ported.data.constants import (
...
from foldforge.models.protenix.ported.data.core import ccd
from foldforge.models.protenix.ported.data.core.ccd import get_ccd_ref_info
from foldforge.models.protenix.ported.data.core.filter import Filter
from foldforge.models.protenix.ported.data.tools.logger import MMCIFStatsLogger
from foldforge.models.protenix.ported.data.tools.rewrite_biotite import _parse_inter_residue_bonds, concatenate
from foldforge.models.protenix.ported.data.utils import (
...
class MMCIFParser:
    ...
    def get_structure(
        ...
        if "struct_conn" in block:
            ...
            if bond_lenth_threshold is not None:
                conn_bonds = _replace_bond_array(conn_bonds, conn_bonds.as_array()[dist < bond_lenth_threshold])
    ...
    def build_ref_chain_with_atom_array(
        ...
        for entity_id, poly_type in self.entity_poly_type.items():
            ...
            inter_bonds = _replace_bond_array(inter_bonds, inter_bonds.as_array()[bond_mask])
    ...
    def add_missing_atoms_and_residues(self, atom_array: AtomArray) -> AtomArray:
        ...
        for atom_i, atom_j, b_type in atom_array.bonds.as_array():
...
class AddAtomArrayAnnot(object):
    ...
    def remove_bonds_between_polymer_chains(
        ...
        bonds = _replace_bond_array(bonds, bonds.as_array()[~pp_bond_mask])
