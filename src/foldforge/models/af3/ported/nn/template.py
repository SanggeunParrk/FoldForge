...
from foldforge.models.af3.ported import (
    fastnn,
    features,
    geometry,
...
from foldforge.models.af3.ported.constants import residue_names
from foldforge.models.af3.ported.nn import pairformer
...
class TemplateEmbedding(nn.Module):
    ...
    def forward(
        ...
        return template_embedding_mean(
            ...
            empty=query_embedding.new_zeros(*query_embedding.shape[:-1], self.num_channels),
