...
from foldforge.models.af3.ported.constants import atom_types
from foldforge.models.af3.ported.nn import template, atom_layout, pairformer
...
class DistogramHead(nn.Module):
    ...
    def forward(
        ...
        contact_probs = torch.einsum('ijk,k->ij', probs.float(), self.is_contact_bin.float())
