...
from foldforge.models.protenix.ported.data.constants import STD_RESIDUES_WITH_GAP
from foldforge.models.protenix.ported.model.modules.fused_ops import dropout_add_rowwise
from foldforge.models.protenix.ported.model.modules.primitives import (
    LinearNoBias,
    Transition,
)
from foldforge.models.protenix.ported.model.modules.transformer import AttentionPairBias
from foldforge.models.protenix.ported.model.triangular.layers import (
    DropoutRowwise,
    LayerNorm,
    OuterProductMean,
)
from foldforge.models.protenix.ported.model.triangular.triangular import (
    TriangleAttention,
    TriangleMultiplicationIncoming,
    TriangleMultiplicationOutgoing,
)
from foldforge.models.protenix.ported.model.utils import (
    checkpoint_blocks,
    expand_at_dim,
    get_checkpoint_fn,
    pad_at_dim,
...
class MSABlock(nn.Module):
    ...
    def __init__(
        ...
        self.msa_update_config = MSAUpdateConfig(update_msa=not is_last_block, return_msa=not is_last_block)
        self.c_m = c_m
        self.c_z = c_z
    ...
    def forward(
        ...
        return msa_pair_update(
            ...
            outer_product_delta=lambda value: self.outer_product_mean_msa(
                value, inplace_safe=inplace_safe, chunk_size=chunk_size),
            msa_residual=lambda value, pair: self.msa_stack(value, pair),
