...
from foldforge.models.opendde.ported.tfg.config import TFGConfig, validate_features
from foldforge.models.opendde.ported.tfg.potentials import Potential
    ...
    def step(
        ...
        *,
        ...
        Args:
            ...
            pair_z_spec: Optional Fold-CP pair-sharding metadata forwarded to
                `denoise_net`.
