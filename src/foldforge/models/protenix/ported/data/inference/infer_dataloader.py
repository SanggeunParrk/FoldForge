...
from foldforge.models.protenix.ported.data.inference.json_to_feature import SampleDictToFeatures
from foldforge.models.protenix.ported.data.msa.msa_featurizer import InferenceMSAFeaturizer
from foldforge.models.protenix.ported.data.template.template_featurizer import InferenceTemplateFeaturizer
from foldforge.models.protenix.ported.data.template.template_utils import TemplateHitFeaturizer
from foldforge.models.protenix.ported.data.utils import data_type_transform, make_dummy_feature
from foldforge.models.protenix.ported.utils.distributed import DIST_WRAPPER
from foldforge.models.protenix.ported.utils.torch_utils import collate_fn_identity, dict_to_tensor
...
class InferenceDataset(Dataset):
    def __init__(
        ...
        if self.esm_enable:
            from foldforge.models.protenix.ported.data.esm.esm_featurizer import ESMFeaturizer
