...
from foldforge.models.protenix.ported.data.msa.msa_utils import map_to_standard
from foldforge.models.protenix.ported.data.template.template_parser import HHRParser, HmmsearchA3MParser
from foldforge.models.protenix.ported.data.template.template_utils import (
...
from foldforge.models.protenix.ported.data.utils import pad_to
from foldforge.models.protenix.ported.utils.file_io import load_json_cached
...
class InferenceTemplateFeaturizer:
    ...
    def make_template_feature(
        ...
        for eid, info in enumerate(bioassembly):
            ...
            templates = []
            if use_template and "proteinChain" in info and "miniworldTemplates" in info["proteinChain"]:
                from foldforge.data.inference.lmdb import template_features

                if t_path:
                    raise ValueError("Choose templatesPath or miniworldTemplates")
                templates = template_features(info["proteinChain"]["miniworldTemplates"], seq, "protenix")
