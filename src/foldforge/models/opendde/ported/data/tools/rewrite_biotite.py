...
PDBX_BOND_TYPE_ID_TO_TYPE = {
    ...
    # "metalc": BondType.COORDINATION,  # no metalc for OpenDDE
}
...
def _parse_inter_residue_bonds(atom_site, struct_conn):
    ...
    if atoms_indices_1 is None or atoms_indices_2 is None:
        raise InvalidFileError("Missing atom indices for inter-residue bonds")
...
def bond_list_concatenate(bonds_lists):
    ...
    merged_bond_list = _replace_bond_array(merged_bond_list, merged_bonds)
