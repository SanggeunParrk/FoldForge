...
URL = {
    ...
    "protenix_base_default_v1.0.0": (
        "https://protenix.tos-cn-beijing.volces.com/checkpoint/protenix_b"
        "ase_default_v1.0.0.pt"
    ),
    "protenix_base_20250630_v1.0.0": (
        "https://protenix.tos-cn-beijing.volces.com/checkpoint/protenix_b"
        "ase_20250630_v1.0.0.pt"
    ),
    "protenix_base_default_v0.5.0": (
        "https://protenix.tos-cn-beijing.volces.com/checkpoint/protenix_b"
        "ase_default_v0.5.0.pt"
    ),
    "protenix_base_constraint_v0.5.0": (
        "https://protenix.tos-cn-beijing.volces.com/checkpoint/protenix_b"
        "ase_constraint_v0.5.0.pt"
    ),
    "protenix_mini_default_v0.5.0": (
        "https://protenix.tos-cn-beijing.volces.com/checkpoint/protenix_m"
        "ini_default_v0.5.0.pt"
    ),
    "protenix_tiny_default_v0.5.0": (
        "https://protenix.tos-cn-beijing.volces.com/checkpoint/protenix_t"
        "iny_default_v0.5.0.pt"
    ),
    ...
    "esm2_t36_3B_UR50D-contact-regression": (
        "https://protenix.tos-cn-beijing.volces.com/checkpoint/esm2_t36_3"
        "B_UR50D-contact-regression.pt"
    ),
    ...
    "esm2_t36_3B_UR50D_ism-contact-regression": (
        "https://protenix.tos-cn-beijing.volces.com/checkpoint/esm2_t36_3"
        "B_UR50D_ism-contact-regression.pt"
    ),
