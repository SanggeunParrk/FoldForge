...
from foldforge.models.opendde.ported.data.constants import CRYSTALLIZATION_AIDS
from foldforge.models.opendde.ported.data.utils import get_inter_residue_bonds
...
class Filter(object):
    ...
    def remove_dissociation(
        ...
        if len(all_chain_pairs) == 0:
            ...
            largest_cc = cast(
                set, max(nx.connected_components(interface_graph), key=len)
            )
